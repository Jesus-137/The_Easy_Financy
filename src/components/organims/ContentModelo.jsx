...
import Information from '../molecules/InformationModelo';
...
function ContentModelo() {
    return (
        <StyledInformation>
            ...
            <Information container={"Information"} title={"Modelo de negocio afiliación"} msn={"Este modelo de afiliación se aplica en el comercio online, al igual que la tradicional venta por comisión, esto funciona cuando un sitio web redirecciona al lector a otro sitio web (normalmente una tienda online) donde -si realiza una serie de acciones (ya sea un registro o una compra)- el sitio web que envía el tráfico recibe una compensación monetaria por ejemplo Amazon."} img={Afil}/>
            <Information container={"Information"} title={"Modelo de negocio de franquicia o licencia"} msn={"Generalmente la franquicia se realiza bajo contrato y puntualizando claramente las responsabilidades de ambas partes, el franquiciante cede el uso de su marca y la transferencia de sus conocimientos tanto técnicos como administrativos, por otro lado el franquiciado debe cumplir todos los estándares de calidad y entrenarse de manera adecuada, dando un buen uso de la marca por ejemplo Burger King."} img={Fran}/>
            <StyledLink to={"/meta"}><Boton data={"Metas"}/></StyledLink>
        </StyledInformation>
    );
}
